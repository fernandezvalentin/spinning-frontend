...
function Login() {
  ...
  // @ts-ignore (Assuming context will be typed later)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-accent/20 blur-3xl opacity-50 mix-blend-screen"></div>
        <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-blue-500/20 blur-3xl opacity-50 mix-blend-screen"></div>
      </div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-text-muted text-sm">Bienvenido de nuevo, preparate para transpirar.</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <Link to="/register" className="text-sm font-medium text-text-muted hover:text-white transition-colors">
            ¿No tenés cuenta? <span className="text-accent hover:text-accent-strong underline decoration-transparent hover:decoration-accent-strong transition-all">Registrate acá</span>
          </Link>
        </div>
      </motion.div>
    </div>
